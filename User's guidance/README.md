...
<br>
<font size=3.5>**2 ALS_genes**</font>. This data object is a vector that contains 260 previously reported Amyotrophic lateral sclerosis associated genes. Please refer to **Table. S7** of SpatialE paper for detailed data sources.<br>
...
The color bars in SpatialE and MIA represent the significance of enrichment (-log conversion of P_bonferroni values) for spatial clusters, while the color bars in SPOTlight and CARD represent the cellular proportion in the decomposition matrix. We set P_bonferroni<0.05 as the significant threshold. Red color indicates regions that are more significantly enriched or have a greater proportion of specific cell types.
